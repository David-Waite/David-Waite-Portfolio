  ...
  const AboutText = (
    <>
      ...
      <p className={styles.description}>
        ...
        clean web designs is what fuels my passion for web development.
        <br />
        ...
        course on Front-End Web Development at Swinburne University. I am now in
        my second year of Computer Science, whilst working on a personal project
