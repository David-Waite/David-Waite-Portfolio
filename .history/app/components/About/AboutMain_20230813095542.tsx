  ...
  const AboutText = (
    <>
      ...
      <p className={styles.description}>
        ...
        started playing around with web development a few years ago but I didn't
        truly get into it until 2022, when I started taking a course on
        Front-End Web Development at Swinburne University. I am now in my second
        year of Computer Science, whilst working on a personal project and
