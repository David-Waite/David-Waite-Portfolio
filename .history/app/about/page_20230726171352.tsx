    ...
    <main>
      <div>
        ...
        <p>
          ...
          passion for web development. I first started playing around with web
          development in primary school, but didn’t get into it until 2022 when
          taking a course on Front-End Web Development at Swinburne University.
          I am currently in my second year studying computer science and doing
