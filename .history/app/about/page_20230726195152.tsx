  ...
  const EducationText = (
    <>
      ...
      <ul className={`${styles.description} ${styles.descriptionList} `}>
        ...
        <li>Front end developer career path (72hrs)</li>
        <li>React Native - The Practical Guide 2022 (26hrs)</li>
        <li>C# Basics for Beginners: Learn C# Fundamentals by Coding (6hrs)</li>
        <li>C# Intermediate: Classes, Interfaces and OOP (6hrs)</li>
        <li>C#</li>
      </ul>
    </>
  );
